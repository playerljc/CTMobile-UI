...
function show(e, t) { var i = setTimeout(() => { clearTimeout(i), e.classList.add('ct-messdialog-dialog-in-show'), t.classList.add('ct-messdialog-dialog-in-show'); }, 100); } function _close(t, i, l, s) { i.addEventListener('transitionend', function e() { i.removeEventListener('transitionend', e), l.classList.remove('ct-messdialog-dialog-in-hide'), i.classList.remove('ct-messdialog-dialog-in-hide'), l.style.display = 'none', t.removeChild(l), l = i = null, s && s(); }), i.classList.remove('ct-messdialog-dialog-in-show'), l.classList.remove('ct-messdialog-dialog-in-show'), i.classList.add('ct-messdialog-dialog-in-hide'), l.classList.add('ct-messdialog-dialog-in-hide'); } function _expressionReplace(e, t) { for (let i = 0, l = _expressions.length; i < l; i++)e = e.replace('<%='.concat(_expressions[i], '%>'), t[_expressions[i]]); return e; } function _$(e, t) { t && (e = _expressionReplace(e, t)); const i = document.createElement('div'); return i.innerHTML = e, i.firstElementChild; } function alertCreate(e) {
  ...
  }); for (var r = document.createDocumentFragment(), g = 0; s && g < s.length; g++) { const u = s[g]; r.appendChild(_$("<span class='ct-messdialog-dialog-in-buttons-button'>".concat(u.text, '</span>'))); }d.appendChild(r), t.appendChild(a), n && n(o); const p = a.querySelector('.ct-messdialog-dialog-in'); return a.style.display = 'flex', show(a, p), { close() { _close(t, p, a); } };
} const makeTextCreate = (function () {
  const t = (function () {
    function t(e) { (0, _classCallCheck2.default)(this, t), this.config = e, this.toastQueue = [], this.toastKey = !1, this.init(); } return (0, _createClass2.default)(t, [{ key: 'init',
      value() {
        let e = this.config,
          t = e.parent,
          i = e.text,
          l = e.position,
          s = e.duration; s = s === 'long' ? 2e3 : 1e3; const n = _$(_template.toast, { text: i, position: l }); this.toastQueue.push({ parent: t, toast: n, duration: s }), this.toastKey || (this.toastKey = !0, this.showToast());
      } }, { key: 'showToast',
      value() {
        const t = this; if (this.toastQueue.length !== 0) {
          let i = this.toastQueue.shift(),
            l = i.duration,
            s = i.parent,
            n = (i = i.toast).querySelector('.ct-messdialog-toast-wrap'); s.appendChild(i), i.style.display = 'flex'; setTimeout(() => { clearTimeout(e), n.classList.add('ct-messdialog-toast-show'); var e = setTimeout(() => { clearTimeout(e), n.addEventListener('transitionend', function e() { n.removeEventListener('transitionend', e), i.style.display = 'none', s.removeChild(i), t.showToast(); }), n.classList.remove('ct-messdialog-toast-show'); }, l); }, 100);
        } else this.toastKey = !1;
      } }]), t;
  }()); return function (e) { new t(e); };
}()); function makeLoadingCreate(e) {
  let t = e.parent,
    i = e.refreshCallback,
